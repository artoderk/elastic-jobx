...
public class ShardingService {
    ...
    private final GlobalConfigurationService globalConfigService;
    ...
    public void shardingIfNecessary() {
        ...
        clearShardingInfo();
        JobShardingStrategy jobShardingStrategy = JobShardingStrategyFactory.getStrategy(globalConfigService, configService.getJobShardingStrategyClass());
