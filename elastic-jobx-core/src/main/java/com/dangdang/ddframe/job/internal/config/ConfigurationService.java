...
public class ConfigurationService {
    ...
    private void registerJobInfo() {
        ...
        jobNodeStorage.fillJobNodeIfNullOrOverwrite(ConfigurationNode.SKIP_TIME_START, jobNodeStorage.getJobConfiguration().getSkipTimeStart());
        jobNodeStorage.fillJobNodeIfNullOrOverwrite(ConfigurationNode.SKIP_TIME_END, jobNodeStorage.getJobConfiguration().getSkipTimeEnd());
    ...
    public boolean inSkipTime(Date now) {
    	// 本作业跳过执行期间
    	Date startDate = DateUtil.parseDate(jobNodeStorage.getJobNodeData(ConfigurationNode.SKIP_TIME_START));
    	Date endDate   = DateUtil.parseDate(jobNodeStorage.getJobNodeData(ConfigurationNode.SKIP_TIME_END));
