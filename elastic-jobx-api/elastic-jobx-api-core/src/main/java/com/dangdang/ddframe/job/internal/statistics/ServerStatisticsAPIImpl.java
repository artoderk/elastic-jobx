...
public final class ServerStatisticsAPIImpl implements ServerStatisticsAPI {
    ...
    public Collection<ServerBriefInfo> getAllServersBriefInfo() {
        Map<String, String> serverHostMap = new HashMap<String, String>();
        Collection<String> aliveServers = new ArrayList<String>();
        Collection<String> crashedServers = new ArrayList<String>();
        ...
        List<ServerBriefInfo> result = new ArrayList<ServerBriefInfo>(serverHostMap.size());
    ...
    public Collection<ServerInfo> getJobs(final String serverIp) {
        List<String> jobs = registryCenter.getChildrenKeys("/");
        Collection<ServerInfo> result = new ArrayList<ServerInfo>(jobs.size());
