...
import com.dangdang.ddframe.job.internal.settings.GlobalSettingsAPIImpl;
...
public final class JobAPIFactory {
     ...
     * @return 操作全局配置API对象
     */
    public static GlobalSettingsAPI createGlobalSettingsAPI(final String connectString, final String namespace, final Optional<String> digest) {
        return new GlobalSettingsAPIImpl(RegistryCenterFactory.createCoordinatorRegistryCenter(connectString, namespace, digest));
    }
}
